...
<table>
    <tr>
		<?php
			$atcols = mysqli_query($con, "SHOW COLUMNS FROM assetstoragetypemaster");
...
$brsql = mysqli_query($con, "SELECT * FROM assetstoragetypemaster");
    ...
    <div class="card">
        ...
        <div class="card_info">
            ...
            <?php
                ...
                if (isset($_POST['save'])) {
                    extract($_POST);
                    $sql = mysqli_query($con,"INSERT INTO assetstoragetypemaster (StorageTypeName,IsActive) VALUES ('$assetstatus','$isactive')");
                    if ($sql) {
