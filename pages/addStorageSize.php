...
<table>
    <tr>
		<?php
			$atcols = mysqli_query($con, "SHOW COLUMNS FROM assetstoragesizemaster");
...
$brsql = mysqli_query($con, "SELECT * FROM assetstoragesizemaster");
...
<div class="container">
    <div class="card">
        <h1 class="card_title">Add Storage Size</h1>
        <p class="card_title-info"></p>
        <form class="card_form" method="post">
            <div class="input">
                <input type="text" name="size" class="input_field" required />
                <label class="input_label">Storage Size</label>
            </div>
            <div class="input">                
        ...
        <div class="card_info">
            ...
            <?php
                ...
                if (isset($_POST['save'])) {
                    extract($_POST);
                    $sql = mysqli_query($con,"INSERT INTO assetstoragesizemaster (StorageSize,IsActive) VALUES ('$size','$isactive')");
                    if ($sql) {
