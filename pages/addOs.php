<h3>All Operating System</h3>
<div class="resp-table">
<table>
    <tr>
		<?php
			$atcols = mysqli_query($con, "SHOW COLUMNS FROM operatingsystemmaster");
...
$brsql = mysqli_query($con, "SELECT * FROM operatingsystemmaster");
...
<div class="container">
    <div class="card">
        <h1 class="card_title">Add New OS</h1>
        <p class="card_title-info"></p>
        <form class="card_form" method="post">
            <div class="input">
                <input type="text" name="osname" class="input_field" required />
        ...
        <div class="card_info">
            ...
            <?php
                ...
                if (isset($_POST['save'])) {
                    extract($_POST);
                    $sql = mysqli_query($con,"INSERT INTO operatingsystemmaster (OperatingSystemName,IsActive) VALUES ('$osname','$isactive')");
                    if ($sql) {
