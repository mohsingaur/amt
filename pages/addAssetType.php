<h3>All Asset Type</h3>
<div class="resp-table">
<table>
    <tr>
		<?php
			$atcols = mysqli_query($con, "SHOW COLUMNS FROM assettypemaster");
...
$brsql = mysqli_query($con, "SELECT * FROM assettypemaster");
...
<div class="container">
    <div class="card">
        <h1 class="card_title">Add Asset Type</h1>
        <p class="card_title-info"></p>
        <form class="card_form" method="post">
            <div class="input">
                <input type="text" name="typename" class="input_field" required />
                <label class="input_label">Asset Type</label>
            </div>
            <div class="input">                
        ...
        <div class="card_info">
            ...
            <?php
                ...
                if (isset($_POST['save'])) {
                    extract($_POST);
                    $sql = mysqli_query($con,"INSERT INTO assettypemaster (AssetType,IsActive) VALUES ('$typename','$isactive')");
                    if ($sql) {
